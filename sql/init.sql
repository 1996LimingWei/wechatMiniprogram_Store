...
CREATE TABLE `trade_after_sale` (
    ...
    `refund_channel_state` varchar(32) NOT NULL DEFAULT '' COMMENT '最近渠道退款状态',
    `refund_exception_code` varchar(64) NOT NULL DEFAULT '' COMMENT '退款异常编码',
    `refund_exception_message` varchar(255) NOT NULL DEFAULT '' COMMENT '退款异常说明',
    `refund_handled` tinyint NOT NULL DEFAULT 0 COMMENT '退款异常处理状态 0=未处理 1=已处理',
    `refund_handle_remark` varchar(255) NOT NULL DEFAULT '' COMMENT '退款异常处理备注',
    `refund_handle_admin_id` bigint DEFAULT NULL COMMENT '退款异常处理管理员ID',
    `refund_handle_time` datetime DEFAULT NULL COMMENT '退款异常处理时间',
...
CREATE TABLE `trade_reconcile_batch` (
    `id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `trade_reconcile_difference` (
    `id` bigint NOT NULL AUTO_INCREMENT,
