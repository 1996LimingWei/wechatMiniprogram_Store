...
public class AppMemberController {
    ...
    public CommonResult<Map<String, Object>> center(HttpServletRequest request) {
        ...
        currentBenefits.put("discount", level == 2 ? "全场9折" : "无专属折扣");
        currentBenefits.put("shipping", level == 2 ? "优先发货" : "标准发货");
        currentBenefits.put("coupon", level == 2 ? "每月赠送优惠券" : "无专属优惠券");
    ...
    public CommonResult<Map<String, Object>> goldCard(HttpServletRequest request) {
        ...
        // 黄金会员权益
        data.put("price", 9900); // 99元（单位：分）
        data.put("originalPrice", 19900); // 原价199元
        ...
        data.put("benefits", new Object[]{
                ...
                Map.of("icon", "shipping", "title", "优先发货", "desc", "订单优先处理， faster 配送"),
